...
<div>
    ...
    <div class="rigt_navbar" id="content">
        <!-- <h3 class="main_header display_non">Import Sku Master File</h3> -->
         <div class="invoic_srch">
            <div class="invoic_srcw pdong_btm">
                <h3 class="sub_header1">Import Sku Master File</h3>
...
export default {
  ...
  data () {
    return {
      headerText: "Import Sku Master File",
      file: "",
      disable: false
    }
  },
  ...
  methods: {
    ...
    importFile () { 
      ...
      const params = {
                      ...
                      master_file_type: 'Client Sku Master',
      ...
      this.$http.secured.post('/admin/master_file_uploads', formData)
        .then(response => {
          this.$router.push('/api/v1/manual_process/sku-master-upload-list');
