...
<div>
    ...
    <div class="rigt_navbar" id="content">
        <!-- <h3 class="main_header display_non">Import Vendor Master File</h3> -->
         <div class="invoic_srch">
            <div class="invoic_srcw pdong_btm">
                <h3 class="sub_header1">Import Vendor Master File</h3>
...
export default {
  ...
  data () {
    return {
      headerText: "Import Vendor Master File",
      file: "",
      disable: false
    }
  },
  ...
  methods: {
    ...
    importFile () { 
      ...
      // this.$toast.warning('Liquidation Vendors will not be created please contact to support team.');
      ...
      const params = {
                      ...
                      master_file_type: 'Vendor Master',
      ...
      this.$http.secured.post('/admin/master_file_uploads', formData)
        .then(response => {
          this.$router.push('/api/v1/manual_process/vendor-master-upload-list');
