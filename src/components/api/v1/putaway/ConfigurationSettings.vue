          ...
          <v-flex class xs12 style="background-color: grey lighten-3">
            <v-row>
              <v-col xs3 cols="4" sm="4" md="4">
                <router-link :to="{ name: 'StoreMasterUploadList'}">
                  <v-card
                  ...
                  >
                    <div align="center" justify="center">
                      <img
                        class="mt-3"
                        src="@/assets/images/icons/ineard_module_icon.svg"
                        width="108"
                        height="108"
                      />
                    </div>
              ...
              <v-col xs3 cols="4" sm="4" md="4">
                <router-link :to="{ name: 'SkuMasterUploadList'}">
                  <v-card
                    class="pa-4 box_shadow_class"
                  >
                    <div align="center" justify="center">
                      <img
                        class="mt-3"
                        src="@/assets/images/icons/grading_module-icon.svg"
                        width="108"
                        height="108"
                      />
                    </div>
              ...
              <v-col xs3 cols="4" sm="4" md="4">
                <router-link :to="{ name: 'SubLocations' }">
                  <v-card
                    class="pa-4 box_shadow_class"
                  >
                    <div align="center" justify="center">
                      <img
                        class="mt-3"
                        src="@/assets/images/putaway_module.svg"
                        width="108"
                        height="108"
                      />
                    </div>
            ...
            <!-- <v-row>
              ...
              <v-col xs3 cols="4" sm="4" md="4">
                <router-link :to="{ name: 'VendorMasterUploadList', params: { type: 'Brand Call-Log' }}">
                  <v-card
                    class="pa-4 box_shadow_class"
                  >
                    <div align="center" justify="center">
...
<script>
  ...
  export default {
    data() {
      return {
        headerText: "Configuration Settings"
      };
    },
