...
<div>
   <div class="rigt_navbar" id="content">
      ...
      <ul class="cutome_tabs nav nav-tabs" role="tablist">
         ...
         <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu1" v-on:click="activateApproved" v-if="this.$store.state.currentUser.roles[0] == 'service_executive'">Approved</a></li>
      </ul>
                  ...
                  <div class="table_colmw table_bordr">
                     <div class="table_clpp11">
                        <div class="custom-control custom-checkbox mb-3">
                           <input type="checkbox" id="customCheck1" v-model="selectAll" name="example1"><label  for="customCheck1"></label></div>
                     </div>
