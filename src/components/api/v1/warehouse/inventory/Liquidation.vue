    ...
    <div>
      <div class="rigt_navbar" id="content">
        <ul class="breadcrambs display_non">
          ...
          <li><a href="#">Pending Liquidation</a></li>
        </ul>
        <h3 class="main_header display_non">Pending Liquidation</h3>
...
export default {
  ...
  methods: {
    getInventories () {
      this.$http.secured.get('/api/v1/warehouse/inventories/liquidation')
      .then(response => {
