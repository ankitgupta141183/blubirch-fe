    ...
    <div>
      <div class="rigt_navbar" id="content">
        <ul class="breadcrambs display_non">
          ...
          <li><a href="#">Pending Brand Call-Log</a></li>
        </ul>
        <h3 class="main_header display_non">Pending Brand Call-Log</h3>
        <div class="check_table">
          <div class="check_tablw stow_scroll" style="height: 540px;">
            <div class="table_colmw table_bordr">
              <div class="table_cols2"><h4 class="table_head1">Brand</h4></div>
              <div class="table_cols2"><h4 class="table_head1">Item Description</h4></div>
              <div class="table_cols2"><h4 class="table_head1">Tag Number</h4></div>
              <div class="table_cols2"><h4 class="table_head1">Client SKU Code</h4></div>
              <div class="table_cols2"><h4 class="table_head1">Inventory Status</h4></div>
              ...
              <div class="table_cols2"><h4 class="table_head1">Origin Store</h4></div>
              <div class="table_cols2"><h4 class="table_head1">City</h4></div>
              <div class="table_cols2"><h4 class="table_head1">Claim Value</h4></div>
            </div>
            <div v-for="inventory in inventories" :key="inventory.id" :inentory="inventory" class="table_colmw table_bordr table_poup">
              <div class="table_cols2"><h4 class="table_head1"><span>{{inventory.brand}}</span></h4></div>
              <div v-if="inventory.details.item_description" class="table_cols2"><h4 class="table_head1"><span>{{inventory.details.item_description}}</span></h4></div>
              ...
              <div v-else class="table_cols2"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.aging" class="table_cols2"><h4 class="table_head1"><span>{{inventory.aging}} days(s)</span></h4></div>
              <div v-else class="table_cols2"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.location_code" class="table_cols2"><h4 class="table_head1"><span>{{inventory.location_code}}</span></h4></div>
              <div v-else class="table_cols2"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.origin_station" class="table_cols2"><h4 class="table_head1"><span>{{inventory.origin}}</span></h4></div>
              <div v-else class="table_cols2"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.city_name" class="table_cols2"><h4 class="table_head1"><span>{{inventory.city_name}}</span></h4></div>
              <div v-else class="table_cols2"><h4 class="table_head1"><span>NA</span></h4></div>
              <div class="table_cols2"><h4 class="table_head1"><span>{{inventory.details.item_price}}</span></h4></div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getInventories () {
      this.$http.secured.get('/api/v1/warehouse/inventories/rtv')
      .then(response => {
