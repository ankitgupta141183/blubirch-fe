    ...
    <div>
      <div class="rigt_navbar" id="content">
        <ul class="breadcrambs display_non">
          ...
          <li><a href="#">Re-stock Inventory</a></li>
        </ul>
        <h3 class="main_header display_non">Re-stock Inventory</h3>
        <div class="check_table">
          <div class="check_tablw stow_scroll" style="height: 540px;">
            <div class="table_colmw table_bordr">
              ...
              <div class="table_cols4"><h4 class="table_head1">Client SKU Code</h4></div>
              <div class="table_cols4"><h4 class="table_head1">Location Code</h4></div>
              <div class="table_cols4"><h4 class="table_head1">Origin Store</h4></div>
              <div class="table_cols4"><h4 class="table_head1">City</h4></div>
            </div>
            <div v-for="inventory in inventories" :key="inventory.id" :inentory="inventory" class="table_colmw table_bordr table_poup">
              ...
              <div v-else class="table_cols4"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.details.sku" class="table_cols4"><h4 class="table_head1"><span>{{inventory.details.sku}}</span></h4></div>
              <div v-else class="table_cols4"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.location_code" class="table_cols4"><h4 class="table_head1"><span>{{inventory.location_code}}</span></h4></div>
              <div v-else class="table_cols4"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.origin_station" class="table_cols4"><h4 class="table_head1"><span>{{inventory.origin}}</span></h4></div>
              <div v-else class="table_cols4"><h4 class="table_head1"><span>NA</span></h4></div>
              <div v-if="inventory.city_name" class="table_cols4"><h4 class="table_head1"><span>{{inventory.city_name}}</span></h4></div>
              <div v-else class="table_cols4"><h4 class="table_head1"><span>NA</span></h4></div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    getInventories () {
      this.$http.secured.get('/api/v1/warehouse/inventories/restock')
      .then(response => {
