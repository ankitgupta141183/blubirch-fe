...
<div>
    ...
    <div class="rigt_navbar" id="content">
        <!-- <h3 class="main_header display_non">Import STN File</h3> -->
         <div class="invoic_srch">
            <div class="invoic_srcw pdong_btm">
                <h3 class="sub_header1">Import PRD File</h3>
  ...
  methods: {
    ...
    importFile () { 
      ...
      this.$http.secured.post('/admin/master_file_uploads', formData)
        .then(response => {
          this.$router.push('/api/v1/warehouse/stn-document-upload-list');
