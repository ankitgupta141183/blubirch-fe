...
export default {
  ...
  data () {
    return {
      headerText: "Lot Creation File Upload",
      uploads: [],
      pageOfItems: [],
      page: 1,
      total_pages: 1
  ...
  methods: {
    ...
    getUploads (page) {
      this.$http.secured.get('/api/v1/warehouse/liquidation_file_uploads', {params: {page: page}})
      .then(response => { 
        this.uploads = this.uploads = response.data.liquidation_file_uploads
